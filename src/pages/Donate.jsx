...
// A free-to-use site with an optional donation. Anyone can open this page
// (parents don't need an account); only the teacher can edit the details.
function Donate() {
  const { user } = useAuth();
  ...
  return (
    <div className={styles.page}>
      ...
      <Card className={styles.section}>
        <BilingualText
          af="Praat Saam! is en bly gratis vir elke leerder. As jy graag wil help om die webwerf te laat groei, is 'n skenking baie welkom, maar glad nie nodig nie."
          en="Praat Saam! is and stays free for every learner. If you'd like to help the website grow, a donation is very welcome, but never required."
        />
